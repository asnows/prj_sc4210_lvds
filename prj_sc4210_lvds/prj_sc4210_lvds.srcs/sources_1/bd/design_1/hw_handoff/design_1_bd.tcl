...
proc create_root_design { parentCell } {
  ...
  set clk_out2_200m [ create_bd_port -dir O -type clk clk_out2_200m ]
  set_property -dict [ list \
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk_out2_200m] [get_bd_pins clk_wiz_0/clk_out2]
