...
#define IMAGE_HSIZE					3840
#define IMAGE_VSIZE					IMAGE_SIZE/IMAGE_HSIZE
...
void vdma_ImgCap_write_init(void)
{
	...
	unsigned int ImgCap1_Addr = ImgCap0_Addr +  1* IMAGE_SIZE ;
	unsigned int ImgCap2_Addr = ImgCap0_Addr +  2* IMAGE_SIZE ;
...
void vdma_videoStr_write_init(void)
{
	...
	unsigned int ImgCap1_Addr = ImgCap0_Addr + 1* IMAGE_SIZE;
	unsigned int ImgCap2_Addr = ImgCap0_Addr + 2* IMAGE_SIZE;
	unsigned int ImgCap3_Addr = ImgCap0_Addr + 3* IMAGE_SIZE;
